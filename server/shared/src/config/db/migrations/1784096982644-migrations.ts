...
export class Migrations1784096982644 implements MigrationInterface {
    name = 'Migrations1784096982644'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "outbound_order" RENAME COLUMN "cancalled_by" TO "cancelled_by"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."outbound_order_status_enum_old" AS ENUM('pending', 'reserving', 'reserved', 'confirming', 'confirmed', 'cancelled', 'cancelling', 'needs_attention')`);
        await queryRunner.query(`ALTER TABLE "outbound_order" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "outbound_order" RENAME COLUMN "cancelled_by" TO "cancalled_by"`);
    }
